...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{canvas_phyllotaxis}\hldef{(}
\hlkwc{colors} \hldef{=} \hlkwd{colorPalette}\hldef{(}\hlsng{"vrolik4"}\hldef{),}
\hlkwc{background} \hldef{=} \hlsng{"#198432"}\hldef{,}
\hlkwc{iterations} \hldef{=} \hlnum{100000}\hldef{,}
\hlkwc{angle} \hldef{=} \hlnum{167.5}\hldef{,}
\hlkwc{size} \hldef{=} \hlnum{0.001}\hldef{,}
\hlkwc{alpha} \hldef{=} \hlnum{3}\hldef{,}
\hlkwc{p} \hldef{=} \hlnum{0.5}
\hldef{)}
\end{alltt}
\end{kframe}
\end{knitrout}
